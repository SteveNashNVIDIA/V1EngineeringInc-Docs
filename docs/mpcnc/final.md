...
the pin side or non-pin side of the plugs.  For the "Individual/Dual Endstop" wiring harness, run each wire all the way from the stepper to the control board.
